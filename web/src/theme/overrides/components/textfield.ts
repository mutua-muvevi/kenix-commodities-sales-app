...
export const textField = (theme: ThemeTypes) => {
	const color = {
	...
	return {
		...
		MuiInput: {
			styleOverrides: {
				underline: {
					"&:before": {
						borderBottomColor: alpha(theme.palette.grey[500].toString(), 0.32),
					},
					"&:after": {
		...
		MuiOutlinedInput: {
			styleOverrides: {
				...
				notchedOutline: {
					borderColor: alpha(theme.palette.grey[500].toString(), 0.2),
		...
		MuiFilledInput: {
			styleOverrides: {
				root: {
					...
					"&:hover": {
						backgroundColor: alpha(theme.palette.grey[500].toString(), 0.16),
					},
